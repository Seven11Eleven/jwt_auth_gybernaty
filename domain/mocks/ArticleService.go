...
func (_m *ArticleService) Create(ctx context.Context, article *domain.Article) error {
...
func (_m *ArticleService) FetchByUserID(ctx context.Context, userID uuid.UUID) ([]domain.ArticleResponse, error) {
...
func (_m *ArticleService) GetByID(ctx context.Context, artID uuid.UUID) (*domain.ArticleResponse, error) {
