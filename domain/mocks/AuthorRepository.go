...
func (_m *AuthorRepository) CheckUsernameExists(ctx context.Context, username string) (bool, error) {
...
func (_m *AuthorRepository) Fetch(ctx context.Context) ([]domain.AuthorResponse, error) {
	ret := _m.Called(ctx)
...
func (_m *AuthorRepository) GetByID(ctx context.Context, id uuid.UUID) (*domain.Author, error) {
...
func (_m *AuthorRepository) GetByUsername(ctx context.Context, username string) (*domain.Author, error) {
	ret := _m.Called(ctx, username)
